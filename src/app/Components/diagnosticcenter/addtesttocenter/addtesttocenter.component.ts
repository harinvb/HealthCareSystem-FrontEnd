...
import { TestService } from 'src/app/diagnostictest/test.service';
...
centertest!:any[];
centerid!: number;
  constructor(private centerService:CenterService, private testService:TestService, private actRouter:ActivatedRoute, private router: Router,private fb: FormBuilder) { }
  ...
  addTest(testid:number){
    ...
    this.centerService.addTestToCenter(this.centerid,testid).subscribe(data=>{
