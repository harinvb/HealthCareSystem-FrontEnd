...
export class GetallcentersComponent implements OnInit {
  ...
  errorMessage!:any;
  searchText:any;
  constructor(private centerService:CenterService,private router:Router, private testService:TestService) { }
  ...
  getAllCenters(){
    this.centerService.getAllDiagnosticCenters().subscribe(data=>{this.center=data;console.log(data);});
  }
