...
export class DiagnosticTestServiceService {
  ...
  getAllTest(): Observable<DiagnosticTest[]> {
    return this.httpClient
      .get<DiagnosticTest[]>(this.url + '/DiagnosticTest/getAllTests/')
      .pipe(catchError(this.handleError));
  }
  addTest(dtest: any): Observable<any> {
    return this.httpClient
      .post<DiagnosticTest>(
        this.url + '/DiagnosticTest/addNewTest/',
  ...
  updateTest(dtest: any): Observable<any> {
    return this.httpClient
      .put<DiagnosticTest>(
        this.url + '/DiagnosticTest/updateTestDetail/',
        JSON.stringify(dtest),
        this.httpOptions
      )
      .pipe(catchError(this.handleError));
  ...
  deleteTest(dtest: any): Observable<any> {
    return this.httpClient
      .delete<DiagnosticTest>(this.url + '/Test/removetest/' + dtest)
      .pipe(catchError(this.handleError));
  }
  getTestsofDiagnosticCenter(centerId: number): Observable<any> {
    return this.httpClient
      .get<DiagnosticTest>(this.url + '/getTestofDiagnosticCenter/' + centerId)
      .pipe(catchError(this.handleError));
  }
